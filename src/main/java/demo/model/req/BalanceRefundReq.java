...
public class BalanceRefundReq {
  ...
  public void refund(IBalanceService service, ApplicationEventPublisher eventPublisher) {
    BalanceDO balance =
        service
    ...
    eventPublisher.publishEvent(
        new BalanceLogEvent(this, balance, oldBalance, amount, BalanceChangeType.REFUNDED));
  }
}
